...
namespace loloof64 {
    ...
    struct HistoryItem
    {
        ...
        HistoryItem(std::string moveFan, std::string newPositionFen, MoveCoordinates lastMove):
    ...
    public:
        ...
        // Empty cell is represented by a simple blankspace ' '.
